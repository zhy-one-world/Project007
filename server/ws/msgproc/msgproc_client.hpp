...
namespace faith
{
	...
	void c2ws_req_get_construction_buff(uint32 conn_index, const void* data_ptr, size_t data_len); //注释掉了
	...
	void c2ws_req_enter_legion_boss_map(uint32 conn_index, const void* data_ptr, size_t data_len); // 注释废弃
	...
	void c2ws_req_get_occupation_daily_award(uint32 conn_index, const void* data_ptr, size_t data_len); // 直接返回，废弃
	void c2ws_req_get_legion_rank(uint32 conn_index, const void* data_ptr, size_t data_len);
	void c2ws_req_fire_bonfire(uint32 conn_index, const void* data_ptr, size_t data_len);   // 注释废弃
	...
	// team
	void c2ws_req_let_role_join_team(uint32 conn_index, const void* data_ptr, size_t data_len);   // 相关逻辑没有
	...
	void c2ws_req_ready_transfer(uint32 conn_index, const void* data_ptr, size_t data_len);  // 注释废弃
	...
	void c2ws_req_update_team_attribute(uint32 conn_index, const void* data_ptr, size_t data_len); // 消息注册废弃
	...
	void c2ws_get_marry_couple_info_proc(uint32 conn_index, const void *data_ptr, size_t data_len); // 废弃
	...
	void c2s_cancel_assist_fight_proc(uint32 connindex, const void * data_ptr, size_t data_len); // 消息在CS
