/********************************************************************
  ...
  purpose: sdk login
*********************************************************************/
#ifndef _LOGIN_SERVICE_SDK_HPP_
#define _LOGIN_SERVICE_SDK_HPP_
...
namespace hld
{
	class login_service_zw : public login_service , public singleton<login_service_zw>
	{
		friend class singleton<login_service_zw>;
	public:
		login_service_zw() { m_time_count = 0; };
		~login_service_zw()	{};
	...
	private:
		...
		void								save_account(const xstring& account, const xstring& server_msg, const s_client_uid client_uid, int64* ban_role_array, int64* ban_chat_array, int32 age = 0);
	private:
		int32								m_time_count;
