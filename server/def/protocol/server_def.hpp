...
#pragma pack(push,1)
	...
	//gateway
	#define GATEWAY_SERVER_SCHEDULER_THREAD_COUNT 255
	#define GATEWAY_NETWORK_SCHEDULER_THREAD_ID 1
	#define GATEWAY_ACCEPTOR_SCHEDULER_THREAD_ID 0
	#define GATEWAY_CLIENT_SEND_BUFF_SIZE	32*1024*1024
	#define GATEWAY_CLIENT_RECV_BUFF_SIZE	32*1024*1024
	#define GATEWAY_INTERNAL_SERVER_SEND_BUFF_SIZE	128*1024*1024
	#define GATEWAY_INTERNAL_SERVER_RECV_BUFF_SIZE	128*1024*1024
	#define GATEWAY_INTERNET_MAX_PACKAGE_SIZE	16*1024
	#define GATEWAY_INTERNET_SERVER_SEND_BUFF_SIZE	1024*1024
	#define GATEWAY_INTERNET_SERVER_RECV_BUFF_SIZE	1024*1024
	//daemon
	...
	// gateway
	const int32 GATEWAY_NEED_CLIENT_COUNT = SERVER_WS_COUNT + SERVER_CS_COUNT + SERVER_DAEMON_COUNT;
	// daemon
	const int32 DAEMON_NEED_SERVER_COUNT = SERVER_WS_COUNT + SERVER_DP_COUNT + SERVER_CS_COUNT + SERVER_GATEWAY_COUNT + SERVER_GMT_COUNT;
	// gate
