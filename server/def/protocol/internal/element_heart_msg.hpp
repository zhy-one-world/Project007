...
#pragma pack(push,1)
	...
	enum
	{
		e_msgindex_dp2cs_load_char_element_heart = hld::e_msg_base_element_heart,
		e_msgindex_cs2dp_save_char_element_heart,
	};

	// DP2CS 分批发送玩家的所有物品信息
	struct dp2cs_load_char_element_heart : public hld::packet_base
	{
		guid_64								role_guid;
	...
	struct cs2dp_save_char_element_heart : public hld::packet_base
	{
		guid_64								role_guid;
