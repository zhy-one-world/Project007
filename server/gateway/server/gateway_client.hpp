...
namespace faith
{
	//	Gateway server is a client of ws
	class gateway_client : public singleton<gateway_client>
	{
		friend class singleton<gateway_client>;
...
#endif//#define __GATEWAY_SERVER_H_
